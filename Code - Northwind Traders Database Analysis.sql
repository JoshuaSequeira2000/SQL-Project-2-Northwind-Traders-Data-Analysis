...
-- 12) Most expensive product and least expensive product based on UnitPrice
select * from Product
...
-- 13) View to see the number of order's made by each customer.
...
-- 14) View to see all count of orders made in each month for each year in pivot table format.
with PivotTable as
